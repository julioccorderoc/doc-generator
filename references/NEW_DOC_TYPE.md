...
No raw `Decimal` or `date` objects in the returned dict. Use `build_line_items`, `build_line_items_meta`, `build_totals`, `get_css_path`, `primary_color_css` from `builders._shared`.
