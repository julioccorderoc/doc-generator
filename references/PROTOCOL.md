...
5. **Handle logo gracefully** — if the user mentions a logo or branding, ask for the file path or image. Use your Read tool to read the file from disk and encode it as a base64 data URI (`data:image/...;base64,...`) before including it in the payload. If they don't mention a logo, do not ask.
